...
export default function CanbriWebsite() {
  ...
  return (
    <div className={theme === "dark" ? "theme-dark" : "theme-light"} style={{ fontFamily: "'Inter', sans-serif", background: "var(--paper)", color: "var(--ink)" }}>
      ...
      {/* ---------- DESKTOP SIDEBAR ---------- */}
      <aside
        className="hidden lg:flex fixed top-0 left-0 h-full w-60 flex-col z-40"
        style={{ background: "var(--navy-deep)", borderRight: "1px solid rgba(255,255,255,0.08)" }}
      >
        <button onClick={() => scrollToId("top")} className="px-5 py-6 text-left">
          <Logo />
        </button>
          ...
          {NAV_LINKS.map((l) => {
            ...
            return (
              <button
                ...
                className="flex items-center gap-3 rounded-md px-3 py-2.5 font-mono text-left"
                style={{
              ...
              >
                <Icon size={16} /> {l.label.toUpperCase()}
              </button>
            );
          })}
        </nav>

        <div className="px-4 py-5 flex flex-col gap-2" style={{ borderTop: "1px solid rgba(255,255,255,0.08)" }}>
          <div className="flex items-center gap-2">
            <button
              onClick={() => setTheme((t) => (t === "light" ? "dark" : "light"))}
              aria-label="Toggle theme"
              className="flex items-center justify-center rounded-md"
              style={{ width: 40, height: 38, border: "1px solid rgba(255,255,255,0.15)" }}
            >
              {theme === "light" ? <Moon size={16} color="white" /> : <Sun size={16} color="white" />}
            </button>
            <button
              onClick={() => setCartOpen(true)}
              className="relative flex items-center justify-center rounded-md flex-1"
              style={{ height: 38, border: "1px solid rgba(255,255,255,0.15)" }}
      ...
      <div
        ...
        style={{ background: "var(--navy-deep)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}
      >
      ...
      {/* ---------- MOBILE NAV DRAWER ---------- */}
      {navOpen && (
        <div className="lg:hidden fixed inset-0 z-50 flex flex-col" style={{ background: "var(--navy-deep)" }}>
      ...
      <main className="lg:pl-60 pt-16 lg:pt-0">
        {/* ANNOUNCEMENT BAR */}
        {announcementOpen && (
          <div className="flex items-center justify-between gap-3 px-6 py-2.5" style={{ background: "var(--navy)" }}>
        ...
        <section
          ...
          style={{ background: "radial-gradient(ellipse 60% 50% at 85% 0%, rgba(200,236,247,0.18), transparent 60%), var(--navy)" }}
        >
        ...
        {/* ---------- QUICK FACTS ---------- */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 px-6 py-10" style={{ background: "var(--navy-deep)" }}>
          {FACTS.map((f, i) => (
            <div key={i}>
        ...
        {/* ---------- TICKER ---------- */}
        <div className="ticker-wrap py-3" style={{ background: "var(--navy-deep)", borderTop: "1px solid rgba(255,255,255,0.06)" }}>
        ...
        <section className="px-6 py-16" style={{ background: "var(--navy)" }}>
          <div className="max-w-5xl mx-auto rounded-2xl p-10 flex flex-col md:flex-row items-center justify-between gap-6" style={{ background: "var(--navy-deep)", border: "1px solid rgba(255,255,255,0.1)" }}>
            <div>
        ...
        {/* ---------- CONTACT ---------- */}
        <section id="contact" className="px-6 py-24" style={{ background: "var(--navy-deep)" }}>
        ...
        {/* ---------- FOOTER ---------- */}
        <footer className="px-6 py-14" style={{ background: "var(--navy-deep)", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
          <div className="max-w-7xl mx-auto">
